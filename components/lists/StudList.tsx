    ...
    try {
      ...
      setTimeout(() => {
        ...
        handleFetch("studs", "_table", true)
                  ...
                  tabRef.current
                    ...
                    .forEach((btn, i) => {
                      try {
                        addListenerAlocation(
                          btn,
                          document.getElementById("avStudListDlg") ??
                            tabRef.current?.closest("dialog"),
                          mainDlgRef.current,
                          "Stud",
                          state,
                          dispatch,
          ...
          .catch(e =>
            console.error(`Failed to fetch from Studs Table: ${e.message}`)
          )
          .finally(() => {
            setTimeout(
              () =>
