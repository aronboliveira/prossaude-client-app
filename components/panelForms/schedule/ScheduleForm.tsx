...
import { useState, useRef, useEffect, useCallback, JSX, useContext, createContext } from "react";
...
import { nullishSel, nullishForm, nullishBtn } from "../../../src/lib/global/declarations/types";
...
import { ScheduleCtxProps } from "@/lib/global/declarations/interfaces";
export const ScheduleCtx = createContext<ScheduleCtxProps>({
  nHrs: [18, 19, 20, 21],
  nCols: [1, 2, 3, 4, 5, 6, 7, 8, 9],
...
export default function ScheduleForm({ mainRoot, children }: ScheduleFormProps): JSX.Element {
  const userClass = useContext(PanelCtx).userClass,
    ...
    monthRef = useRef<nullishSel>(null),
    btnExportSchedRef = useRef<nullishBtn>(null),
