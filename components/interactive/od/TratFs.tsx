  ...
  return (
    ...
    >
      <legend className="legMain" id="fsRelTratLeg">
        ...
        <span
          role="group"
          className="spanMain tratMainSpan tratButSpan"
          id="tratButSpan1"
        >
          <button
            type="button"
        ...
        <table id="tratContainer">
          ...
          <thead className="tratHead">
            <tr className="tratHeader">
              ...
              <th
                className="tratMainSpan tratLabel tratTaLab noInvert"
                id="labTratTip1"
              >
                Tipo de Tratamento
              </th>
              <th className="tratMainSpan tratLabel tratDateLab noInvert">
                Data
              </th>
              <th
                id="spanAstTratId1"
                className="tratMainSpan tratLabel tratAstLab noInvert"
              >
                Assinatura
              </th>
            </tr>
          ...
          <tbody className="tratTBody">
            <tr className="divSub divSubTrat" id="divSubTrat1">
              <th
                className="spanMain tratMainSpan tratNumSpan noInvert"
                id="tratNumSpan1"
              >
                1)
              </th>
              <td
                className="spanMain tratMainSpan tratTypeSpan"
                id="tratTypeSpan1"
              >
                <textarea
              ...
              <td
                className="spanMain tratMainSpan tratDateSpan"
                id="tratDateSpan1"
              >
                <input
                  type="date"
                ...
                <button
                  type="button"
                  className="tratBtn datBtn btn btn-secondary"
                  id="trat2DatBtn"
                >
                  Usar data atual
                </button>
              ...
              <td
                className="spanMain tratMainSpan tratFileSpan"
                id="tratFileSpan1"
              >
                <input
                  type="text"
