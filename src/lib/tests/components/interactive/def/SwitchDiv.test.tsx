...
describe("SwitchDiv Component", (): void => {
  test("renders the auto-fill switch and toggles on change", (): void => {
    ...
    (expect(switchAutoFill) as jest.JestMatchers<jest.SpyInstance>).toHaveBeenCalledWith<
      Parameters<typeof switchAutoFill>
    >(autoFillCheckbox, tabProps.isAutoFillActive) as void;
  }) as void;
}) as void;
