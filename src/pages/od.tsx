        ...
        <main>
          ...
          <form
            ...
            <fieldset name='fsInspBocFacName' id='fsInspBocFacId' className='fsMain'>
              ...
              <InspDlgElements count={1} ctx='lab' fullName='Lábios e Mucosa Labial' />
              <InspDlgElements count={2} ctx='jug' fullName='Mucosa Jugal' />
              <InspDlgElements count={3} ctx='vest' fullName='Fundo do Vestíbulo' />
              <InspDlgElements count={4} ctx='pltd' fullName='Palato Duro' />
              <InspDlgElements count={5} ctx='pltm' fullName='Palato Mole e Úvula' />
              <InspDlgElements count={6} ctx='of' fullName='Orofaringe' />
              <InspDlgElements count={7} ctx='lg' fullName='Língua' />
              <InspDlgElements count={8} ctx='asb' fullName='Assoalho da Boca' />
              <InspDlgElements count={9} ctx='mast' fullName='Músculos da Mastigação — Palpação' />
              <InspDlgElements count={10} ctx='peri' fullName='Gengiva Marginal e Inserida (Periodonto)' />
            </fieldset>
            <hr />
