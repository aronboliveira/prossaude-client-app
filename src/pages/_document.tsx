  ...
  return (
    <Html lang='pt-BR'>
      <Head>
        ...
        <meta
          name='generator'
          content={`Next.js ${deps?.dependencies?.next || deps?.devDependencies?.next || "14.2.4"} + TypeScript ${
            deps?.dependencies?.typescript || deps?.devDependencies?.typescript || "5.5.3"
          }`}
        />
        ...
        <link rel='alternate' type='application/json+oembed' href={`${base}/oembed.json`} />
        <link rel='alternate' type='text/xml+oembed' href={`${base}/oembed.xml`} />
        <link rel='alternate' type='application/rss+xml' title='RSS Feed for PROSSaúde' href={`${base}/rss.xml`} />
        ...
        <link rel='apple-touch-icon' href={`${origin}/img/apple-touch-icon-iphone-60x60-precomposed.png`} />
        <link rel='apple-touch-icon' sizes='60x60' href={`${origin}/apple-touch-icon-ipad-76x76-precomposed.png`} />
        <link
...
MyDocument.getInitialProps = async (ctx: DocumentContext): Promise<DocumentNodeProps> => {
