              ...
              <ul>
                <li>
                  <p className='dicas' id='dicaUppercase'>
                    As <strong className='noInvert'>primeiras letras</strong>, exceto conjunções, são capitalizadas
                    automaticamente por padrão. Outras correções de campos complexos podem precisar de mais texto —
                    Continue digitando!
                  </p>
                </li>
              </ul>
        ...
        <section className='tipsSect noInvert' id='consTips'>
          ...
          <details>
            ...
            <div className='noInvert'>
              <ul>
                ...
                <li>
                  <p>
                    Também são disponibilizações <strong className='noInvert'>Listas de dados</strong> para
                    preenchimento ágil, com montagem baseada nos dados do <em className='noInvert'>navegador</em> (como
                    as informações da conta Google, no Google chrome) e comunicação com o banco de dados;
                  </p>
                </li>
                <li>
                  <p>
          ...
          <details>
            ...
            <ul>
              ...
              <li>
                <p>
                  O <strong className='noInvert'>Agendamento</strong> é feito através na seção de agendamento, onde pode
                  ...
                  <ol>
                    ...
                    <li>
                      <p>
                        Através do <strong className='noInvert'>Arraste&nbsp;</strong>
                        para um <em className='noInvert'>espaço livre</em> na agenda;
                      </p>
                    </li>
                  </ol>
                </p>
          ...
          <details>
            ...
            <div className='noInvert'>
              <ul>
                ...
                <li>
                  <p>
                    Usuários de <strong className='noInvert'>outras classes</strong>
                    podem alocar novos agendamentos, mas estem ficarão pendentes para confirmação visualmente e na
                    leitura do sistema;
                  </p>
                </li>
                <li>
          ...
          <details>
            ...
            <div className='noInvert'>
              <ul>
                <li>
                  <p>
                    Para que qualquer <strong className='noInvert'>Ajuste automático</strong> tenha efeito, é necessário
                    que o <em className='noInvert'>Auto-ajuste de mês</em> esteja ativado;
                  </p>
                </li>
                <li>
                  <p>
                    Os <strong className='noInvert'>Dias de trabalho semanais</strong> são manipuláveis e reajustáveis
                    através dos campos de seleção correspondentes;
                  </p>
                </li>
                <li>
                  <p>
                    O <strong className='noInvert'>Mês de trabalho</strong> é ajustável através do campo de seleção
                    correspondente;
                  </p>
                </li>
                <li>
                ...
                <li>
                  <p>
                    Os <strong className='noInvert'>Dias do Mês</strong> na agenda são ajustáveis através do ícone de
                    agenda;
                  </p>
                </li>
              </ul>
          ...
          <details>
            ...
            <div>
              <ul>
                <li>
                  <p>
                    O painel disponibiliza um <strong className='noInvert'>ícone</strong> dinamicamente escolhido com
                    base na <em className='noInvert'>área de trabalho</em> do usuário;
                  </p>
                </li>
                <li>
                  <p>
                ...
                <li>
                  <p>
                    O <strong className='noInvert'>nome</strong> do usuário é listado à esquerda do ícone da sua área de
                    trabalho;
                  </p>
                </li>
              </ul>
          ...
          <details>
            ...
            <div className='noInvert'>
              <ul className='noInvert'>
                <li>
                  <p>
                    As <strong className='noInvert'>Informações adicionais do usuário</strong> são disponibilizadas no
                    dropdown aberto pelo <em className='noInvert'>clique no ícone de área</em>;
                  </p>
                </li>
                <li>
                  <p>
                    ...
                    <ol className='noInvert'>
                      ...
                      <li>
                        <strong className='noInvert'>Logout</strong>: <em className='noInvert'>Saída</em> do sistema,
          ...
          <details className='noInvert'>
            ...
            <div className='noInvert'>
              <ul>
                <li>
                  <p>
                    Para <strong className='noInvert'>fechar</strong> janelas modais, há quatro opções possíveis:
                    <ol>
                      <li>
                        <p>
                          Clicar no
                      ...
                      <li>
                        <p>
                          Clicar <strong className='noInvert'>fora da janela modal</strong>;
                        </p>
                      </li>
                      <li>
                        <p>
                          Apertar <kbd className='kbd noInvert'>Esc</kbd> no teclado;
                        </p>
                      </li>
                      <li>
                        <p>
          ...
          <div>
            <details>
              ...
              <ul>
                <li>
                  <p>
                    Considere <strong className='noInvert'>Desativar a Autocorreção e/ou o Autopreenchimento</strong> em
                    casos de erro no preenchimento automático através dos <em className='noInvert'>Alternadores</em>
                    &nbsp;
                    <input
                      type='checkbox'
                      role='switch'
            ...
            <details>
              ...
              <ul>
                <li>
                  <p>
                    Considere <strong className='noInvert'>Desativar o Auto-ajuste de mês</strong> em casos de erro na
                    montagem dinâmica da agenda de <em className='noInvert'>Atendimento Diário</em>;
                  </p>
                </li>
              </ul>
            </details>
            ...
            <details>
              ...
              <ul>
                <li>
                  <p>
                    No caso de <strong className='noInvert'>erros na interação com o dropdown</strong>, considere clicar
                    no <em className='noInvert'>ícone de janela modal</em>;
                  </p>
                </li>
              </ul>
            </details>
