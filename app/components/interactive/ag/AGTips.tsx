...
const AGTips = memo(({ state, dispatch }: DlgProps): JSX.Element => {
        ...
        <article className='flexNoWC noInvert'>
          ...
          <section className='tipsSect' id='genderSect'>
            ...
            <p
              ...
              <em>
                refere-se à identificação da pessoa quanto a <strong>papéis sociais</strong> associados primariamente
                (na nascença) ao sexo biológico.
                <br />
                <br />
                Biologicamente, indivíduos possuem um genótipo resultante da combinação dos alossomos (crossomos X e Y),
                que possuem o padrão XY: macho; XX: fêmea; no entanto, muitas outras variações genotípicas são
                possíveis, ainda que raras.
                <br />
                <br />
                ...
                <br />
                <br />É importante salientar que a única definição confiável para a biologia de macho ou fêmea é somente
                o <strong>tipo de gameta</strong> e, consequentemente, a genitália em animais;
                <br />
                <br />
                ...
                previsto ao sexo biológico oposto ao de sua nascença (e.g.: machos biológicos que não se identificam com
                o papel de homem, mas de mulher);
                <br />
                <br />
                No segundo caso (
                <strong>
