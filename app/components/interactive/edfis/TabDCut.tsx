...
import { elementNotFound, extLine, typeError } from "@/lib/global/handlers/errorHandler";
import { createArraysRels, getNumCol, updatePGC } from "@/lib/locals/edFisNutPage/edFisNutHandler";
...
export const handleSumClick = (ev: React.MouseEvent): void => {
  ...
  const rowsDCArray = Array.from(
    document.getElementById("tabDCut")?.getElementsByClassName("tabRowDCutMed") ?? [],
