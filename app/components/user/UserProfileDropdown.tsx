    ...
    <div className='po posAb lowPo userPo' ref={poRef}>
      ...
      <div className='bdPo noInvert'>
        ...
        <div id='alterUserPropDiv' className='flexJSt cGap1v mg-1-3b'>
          ...
          <button type='button' className='transparent-el-bg' id='alterUserPropBtn' onClick={togglePropDlg}>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              width='16'
              height='16'
        ...
        <div id='logoutDiv' className='flexJSt cGap1v mg-1t noInvert'>
          ...
          <button type='button' className='transparent-el-bg noInvert' id='contactBtn' onClick={toggleContact}>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              width='16'
              height='16'
